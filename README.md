...
proxies:
  - {name: 🇭🇰 HK, server: 129.226.171.164, port: 43142, type: vmess, uuid: D0FBC101-4860-0A69-A7F6-E537383871D4, alterId: 0, cipher: auto, tls: false, network: ws, ws-opts: {path: /, headers: {Host: 129.226.171.164}}}
proxy-groups:
  - name: Proxies
    type: select
    proxies:
...
rules:
 ...
 - DOMAIN-KEYWORD,qiyi,HKMTMedia
 - DOMAIN-SUFFIX,qy.net,HKMTMedia
 - IP-CIDR,101.227.0.0/16,HKMTMedia,no-resolve
 - IP-CIDR,101.224.0.0/13,HKMTMedia,no-resolve
 - IP-CIDR,119.176.0.0/12,HKMTMedia,no-resolve
 - DOMAIN-SUFFIX,acg.tv,HKMTMedia
 - DOMAIN-SUFFIX,acgvideo.com,HKMTMedia
 - DOMAIN-SUFFIX,b23.tv,HKMTMedia
 - DOMAIN-SUFFIX,biliapi.com,HKMTMedia
 - DOMAIN-SUFFIX,biliapi.net,HKMTMedia
 - DOMAIN-SUFFIX,bilibili.com,HKMTMedia
 - DOMAIN-SUFFIX,biligame.com,HKMTMedia
 - DOMAIN-SUFFIX,biligame.net,HKMTMedia
 - DOMAIN-SUFFIX,bilivideo.com,HKMTMedia
 - DOMAIN-SUFFIX,hdslb.com,HKMTMedia
 - DOMAIN-SUFFIX,im9.com,HKMTMedia
 - DOMAIN-SUFFIX,smtcdns.net,HKMTMedia
 - DOMAIN-SUFFIX,bahamut.com.tw,HKMTMedia
 - DOMAIN-SUFFIX,gamer.com.tw,HKMTMedia
 - DOMAIN-SUFFIX,hinet.net,HKMTMedia
 ...
 - DOMAIN,tv.applemusic.com,Proxies
 - DOMAIN-SUFFIX,deezer.com,Proxies
 - DOMAIN-SUFFIX,dzcdn.net,Proxies
 - DOMAIN-SUFFIX,joox.com,Proxies
 - DOMAIN-KEYWORD,jooxweb-api,Proxies
 - DOMAIN-SUFFIX,kkbox.com,Proxies
 - DOMAIN-SUFFIX,kkbox.com.tw,Proxies
 - DOMAIN-SUFFIX,kfs.io,Proxies
 - DOMAIN-SUFFIX,pandora.com,Proxies
 - DOMAIN-SUFFIX,p-cdn.us,Proxies
 - DOMAIN-SUFFIX,sndcdn.com,Proxies
 - DOMAIN-SUFFIX,soundcloud.com,Proxies
 - DOMAIN-SUFFIX,pscdn.co,Proxies
 - DOMAIN-SUFFIX,scdn.co,Proxies
 - DOMAIN-SUFFIX,spotify.com,Proxies
 - DOMAIN-SUFFIX,spoti.fi,Proxies
 - DOMAIN-KEYWORD,spotify.com,Proxies
 - DOMAIN-KEYWORD,-spotify-com,Proxies
 - DOMAIN-SUFFIX,tidal.com,Proxies
 - DOMAIN-SUFFIX,himalaya.com,Proxies
 ...
 - DOMAIN-KEYWORD,abematv.akamaized.net,Proxies
 - DOMAIN-SUFFIX,c4assets.com,Proxies
 - DOMAIN-SUFFIX,channel4.com,Proxies
 - DOMAIN-SUFFIX,aiv-cdn.net,Proxies
 - DOMAIN-SUFFIX,aiv-delivery.net,Proxies
 - DOMAIN-SUFFIX,amazonvideo.com,Proxies
 - DOMAIN-SUFFIX,primevideo.com,Proxies
 - DOMAIN-SUFFIX,media-amazon.com,Proxies
 - DOMAIN,atv-ps.amazon.com,Proxies
 - DOMAIN,fls-na.amazon.com,Proxies
 - DOMAIN,avodmp4s3ww-a.akamaihd.net,Proxies
 - DOMAIN,d25xi40x97liuc.cloudfront.net,Proxies
 - DOMAIN,dmqdd6hw24ucf.cloudfront.net,Proxies
 - DOMAIN,dmqdd6hw24ucf.cloudfront.net,Proxies
 - DOMAIN,d22qjgkvxw22r6.cloudfront.net,Proxies
 - DOMAIN,d1v5ir2lpwr8os.cloudfront.net,Proxies
 - DOMAIN,d27xxe7juh1us6.cloudfront.net,Proxies
 - DOMAIN-KEYWORD,avoddashs,Proxies
 - DOMAIN,linear.tv.apple.com,Proxies
 - DOMAIN,play-edge.itunes.apple.com,Proxies
 - DOMAIN,uts-api.itunes.apple.com,Proxies
 - DOMAIN-SUFFIX,bahamut.com.tw,Proxies
 - DOMAIN-SUFFIX,gamer.com.tw,Proxies
 - DOMAIN,gamer-cds.cdn.hinet.net,Proxies
 - DOMAIN,gamer2-cds.cdn.hinet.net,Proxies
 ...
 - DOMAIN-SUFFIX,biliintl.com,Proxies
 - DOMAIN,apm-misaka.biliapi.net,Proxies
 - DOMAIN,p.bstarstatic.com,Proxies
 - DOMAIN,p-bstarstatic.akamaized.net,Proxies
 - DOMAIN,upos-bstar-mirrorakam.akamaized.net,Proxies
 - DOMAIN,upos-bstar1-mirrorakam.akamaized.net,Proxies
 - DOMAIN-SUFFIX,dazn.com,Proxies
 - DOMAIN-SUFFIX,dazn-api.com,Proxies
 - DOMAIN-SUFFIX,dazndn.com,Proxies
 - DOMAIN-SUFFIX,indazn.com,Proxies
 - DOMAIN,d151l6v8er5bdm.cloudfront.net,Proxies
 - DOMAIN-KEYWORD,voddazn,Proxies
 - DOMAIN-SUFFIX,disco-api.com,Proxies
 - DOMAIN-SUFFIX,discoveryplus.co.uk,Proxies
 - DOMAIN-SUFFIX,discoveryplus.com,Proxies
 - DOMAIN-SUFFIX,discoveryplus.in,Proxies
 - DOMAIN-SUFFIX,dnitv.com,Proxies
 - DOMAIN-SUFFIX,bamgrid.com,Proxies
 - DOMAIN-SUFFIX,disneyplus.com,Proxies
 - DOMAIN-SUFFIX,disney-plus.net,Proxies
 - DOMAIN-SUFFIX,disneystreaming.com,Proxies
 - DOMAIN-SUFFIX,dssott.com,Proxies
 - DOMAIN,cdn.registerdisney.go.com,Proxies
 - DOMAIN-SUFFIX,dmm.co.jp,Proxies
 - DOMAIN-SUFFIX,dmm.com,Proxies
 - DOMAIN-SUFFIX,dmm-extension.com,Proxies
 - DOMAIN-SUFFIX,encoretvb.com,Proxies
 - DOMAIN,edge.api.brightcove.com,Proxies
 - DOMAIN,bcbolt446c5271-a.akamaihd.net,Proxies
 - DOMAIN-SUFFIX,hbo.com,Proxies
 - DOMAIN-SUFFIX,hbogo.com,Proxies
 - DOMAIN-SUFFIX,hbonow.com,Proxies
 - DOMAIN-SUFFIX,hbomax.com,Proxies
 - DOMAIN-SUFFIX,hbomaxcdn.com,Proxies
 - DOMAIN-SUFFIX,hbogoasia.com,Proxies
 - DOMAIN-SUFFIX,hbogoasia.hk,Proxies
 - DOMAIN-KEYWORD,.hbogoasia.,Proxies
 - DOMAIN,44wilhpljf.execute-api.ap-southeast-1.amazonaws.com,Proxies
 - DOMAIN,bcbolthboa-a.akamaihd.net,Proxies
 - DOMAIN,cf-images.ap-southeast-1.prod.boltdns.net,Proxies
 - DOMAIN,dai3fd1oh325y.cloudfront.net,Proxies
 - DOMAIN,hboasia1-i.akamaihd.net,Proxies
 - DOMAIN,hboasia2-i.akamaihd.net,Proxies
 - DOMAIN,hboasia3-i.akamaihd.net,Proxies
 - DOMAIN,hboasia4-i.akamaihd.net,Proxies
 - DOMAIN,hboasia5-i.akamaihd.net,Proxies
 - DOMAIN,hboasialive.akamaized.net,Proxies
 - DOMAIN,hbogoprod-vod.akamaized.net,Proxies
 - DOMAIN,hbolb.onwardsmg.com,Proxies
 - DOMAIN,hbounify-prod.evergent.com,Proxies
 - DOMAIN,players.brightcove.net,Proxies
 - DOMAIN,s3-ap-southeast-1.amazonaws.com,Proxies
 - DOMAIN-SUFFIX,5itv.tv,Proxies
 ...
 - DOMAIN-SUFFIX,hjholdings.jp,Proxies
 - DOMAIN-SUFFIX,hulu.jp,Proxies
 - DOMAIN-SUFFIX,itv.com,Proxies
 - DOMAIN-SUFFIX,itvstatic.com,Proxies
 - DOMAIN,itvpnpmobile-a.akamaihd.net,Proxies
 - DOMAIN-SUFFIX,iq.com,Proxies
 - DOMAIN,intl.iqiyi.com,Proxies
 - DOMAIN,intl-rcd.iqiyi.com,Proxies
 - DOMAIN,intl-subscription.iqiyi.com,Proxies
 - IP-CIDR,23.53.32.88/32,Proxies,no-resolve
 - IP-CIDR,23.211.15.99/32,Proxies,no-resolve
 - IP-CIDR,103.5.34.153/32,Proxies,no-resolve
 - IP-CIDR,104.109.129.153/32,Proxies,no-resolve
 - IP-CIDR,110.238.107.47/32,Proxies,no-resolve
 - IP-CIDR,118.26.32.178/32,Proxies,no-resolve
 - IP-CIDR,203.74.95.131/32,Proxies,no-resolve
 - IP-CIDR,203.74.95.139/32,Proxies,no-resolve
 - IP-CIDR,203.74.95.153/32,Proxies,no-resolve
 - IP-CIDR,203.211.4.169/32,Proxies,no-resolve
 - IP-CIDR,203.211.4.193/32,Proxies,no-resolve
 - IP-CIDR,210.71.227.200/32,Proxies,no-resolve
 - IP-CIDR,210.71.227.202/32,Proxies,no-resolve
 - IP-CIDR,210.201.32.8/32,Proxies,no-resolve
 - IP-CIDR,210.201.32.11/32,Proxies,no-resolve
 - DOMAIN-SUFFIX,kktv.com.tw,Proxies
 - DOMAIN-SUFFIX,kktv.me,Proxies
 - DOMAIN,kktv-theater.kk.stream,Proxies
 - DOMAIN-SUFFIX,linetv.tw,Proxies
 - DOMAIN,d3c7rimkq79yfu.cloudfront.net,Proxies
 - DOMAIN-SUFFIX,litv.tv,Proxies
 - DOMAIN,litvfreemobile-hichannel.cdn.hinet.net,Proxies
 - DOMAIN-SUFFIX,api.mgtv.com,Proxies
 - DOMAIN,mobileso.bz.mgtv.com,Proxies
 - DOMAIN-SUFFIX,channel5.com,Proxies
 - DOMAIN-SUFFIX,my5.tv,Proxies
 - DOMAIN,d349g9zuie06uo.cloudfront.net,Proxies
 - DOMAIN-SUFFIX,mytvsuper.com,Proxies
 - DOMAIN-SUFFIX,tvb.com,Proxies
 - DOMAIN-SUFFIX,naver.com,Proxies
 - DOMAIN-SUFFIX,smartmediarep.com,Proxies
 ...
 - DOMAIN-SUFFIX,netflixdnstest0.com,Proxies
 - DOMAIN-SUFFIX,netflixdnstest1.com,Proxies
 - DOMAIN-SUFFIX,netflixdnstest2.com,Proxies
 - DOMAIN-SUFFIX,netflixdnstest3.com,Proxies
 - DOMAIN-SUFFIX,netflixdnstest4.com,Proxies
 - DOMAIN-SUFFIX,netflixdnstest5.com,Proxies
 - DOMAIN-SUFFIX,netflixdnstest6.com,Proxies
 - DOMAIN-SUFFIX,netflixdnstest7.com,Proxies
 - DOMAIN-SUFFIX,netflixdnstest8.com,Proxies
 - DOMAIN-SUFFIX,netflixdnstest9.com,Proxies
 - DOMAIN-KEYWORD,dualstack.apiproxy-,Proxies
 - DOMAIN-KEYWORD,dualstack.ichnaea-web-,Proxies
 - IP-CIDR,23.246.0.0/18,Proxies,no-resolve
 - IP-CIDR,37.77.184.0/21,Proxies,no-resolve
 - IP-CIDR,45.57.0.0/17,Proxies,no-resolve
 - IP-CIDR,64.120.128.0/17,Proxies,no-resolve
 - IP-CIDR,66.197.128.0/17,Proxies,no-resolve
 - IP-CIDR,108.175.32.0/20,Proxies,no-resolve
 - IP-CIDR,192.173.64.0/18,Proxies,no-resolve
 - IP-CIDR,198.38.96.0/19,Proxies,no-resolve
 - IP-CIDR,198.45.48.0/20,Proxies,no-resolve
 - IP-CIDR,34.210.42.111/32,Proxies,no-resolve
 - IP-CIDR,52.89.124.203/32,Proxies,no-resolve
 - IP-CIDR,54.148.37.5/32,Proxies,no-resolve
 - DOMAIN-SUFFIX,dmc.nico,Proxies
 - DOMAIN-SUFFIX,nicovideo.jp,Proxies
 - DOMAIN-SUFFIX,nimg.jp,Proxies
 - DOMAIN-SUFFIX,nowe.com,Proxies
 - DOMAIN-SUFFIX,nowestatic.com,Proxies
 - DOMAIN-SUFFIX,cbsi.com,Proxies
 - DOMAIN-SUFFIX,cbsaavideo.com,Proxies
 - DOMAIN-SUFFIX,cbsivideo.com,Proxies
 - DOMAIN-SUFFIX,paramountplus.com,Proxies
 - DOMAIN-SUFFIX,pplusstatic.com,Proxies
 - DOMAIN,cbsi.live.ott.irdeto.com,Proxies
 - DOMAIN,cbsplaylistserver.aws.syncbak.com,Proxies
 - DOMAIN,cbsservice.aws.syncbak.com,Proxies
 - DOMAIN,link.theplatform.com,Proxies
 - DOMAIN-SUFFIX,pbs.org,Proxies
 - DOMAIN-SUFFIX,peacocktv.com,Proxies
 ...
 - DOMAIN,hamifans.emome.net,Proxies
 - DOMAIN-SUFFIX,byteoversea.com,Proxies
 - DOMAIN-SUFFIX,ibytedtos.com,Proxies
 - DOMAIN-SUFFIX,muscdn.com,Proxies
 - DOMAIN-SUFFIX,musical.ly,Proxies
 - DOMAIN-SUFFIX,tiktok.com,Proxies
 - DOMAIN-SUFFIX,tik-tokapi.com,Proxies
 - DOMAIN-SUFFIX,tiktokcdn.com,Proxies
 - DOMAIN-SUFFIX,tiktokv.com,Proxies
 - DOMAIN-KEYWORD,-tiktokcdn-com,Proxies
 - DOMAIN-SUFFIX,tver.jp,Proxies
 - DOMAIN,edge.api.brightcove.com,Proxies
 - DOMAIN-SUFFIX,viu.com,Proxies
 - DOMAIN-SUFFIX,viu.tv,Proxies
 - DOMAIN,api.viu.now.com,Proxies
 - DOMAIN,d1k2us671qcoau.cloudfront.net,Proxies
 - DOMAIN,d2anahhhmp1ffz.cloudfront.net,Proxies
 - DOMAIN,dfp6rglgjqszk.cloudfront.net,Proxies
 - DOMAIN-SUFFIX,wetv.vip,Proxies
 - DOMAIN-SUFFIX,wetvinfo.com,Proxies
 - IP-CIDR,150.109.28.51/32,Proxies,no-resolve
 - DOMAIN-SUFFIX,googlevideo.com,Proxies
 - DOMAIN-SUFFIX,youtube.com,Proxies
 - DOMAIN-SUFFIX,ytimg.com,Proxies
 - DOMAIN,youtubei.googleapis.com,Proxies
 - DOMAIN,yt3.ggpht.com,Proxies
